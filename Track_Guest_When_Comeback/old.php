...
$sql = "INSERT INTO `users` (`ip_address`,`country`, `session_id`, `isp` ,`device`,`model`,`device_name`) VALUES ('" . mysqli_real_escape_string($conn, $ip) . "','" . mysqli_real_escape_string($conn, $country) . "','" . mysqli_real_escape_string($conn, $_SESSION['sessionId']) . "','" . mysqli_real_escape_string($conn, $isp) . "','" . mysqli_real_escape_string($conn, $device) . "','" . mysqli_real_escape_string($conn, $version . " " . " " . $versionName . " " . " " . $model) . "','" . mysqli_real_escape_string($conn, $deviceName) . "')";
